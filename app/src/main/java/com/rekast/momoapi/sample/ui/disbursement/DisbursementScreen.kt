...
@Composable
fun DisbursementScreen(navController: NavController?) {
    ...
    Scaffold(
        ...
        Box(modifier = Modifier.padding(padding)) {
            DisbursementScreenDataView {}
        }
    }
}

@Composable
fun DisbursementScreenDataView(
    ...
    Column(
        ...
        Text(
            text = "This is the disbursement screen",
            fontSize = 16.sp,
...
fun DisbursementScreenPreview() {
    DisbursementScreen(navController = null)
}
