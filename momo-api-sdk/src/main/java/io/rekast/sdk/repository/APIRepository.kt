...
class APIRepository(
    ...
    fun checkApiUser(
        ...
        return CommonAPI().getAuthentication(baseUrl, null)
    ...
    fun getAccessToken(
        ...
        return CommonAPI().getAuthentication(
            baseUrl,
    ...
    fun requestToPay(
        ...
        return CommonAPI().getCollection(
            baseUrl,
            AccessTokenInterceptor(accessToken)
    ...
    fun deposit(
        ...
        return CommonAPI().getDisbursement(
            baseUrl,
            AccessTokenInterceptor(accessToken)
