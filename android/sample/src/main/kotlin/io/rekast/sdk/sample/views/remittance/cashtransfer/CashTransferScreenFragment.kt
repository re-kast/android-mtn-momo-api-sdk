...
@AndroidEntryPoint
class CashTransferScreenFragment : Fragment() {
    private val cashTransferScreenViewModel by viewModels<CashTransferScreenViewModel>()
        ...
        return ComposeView(requireContext()).apply {
            ...
            setContent {
                AppTheme {
                    ...
                    val vmShowProgressBar by cashTransferScreenViewModel.showProgressBar.observeAsState(false)
                    CashTransferScreen(
                        navController = navController,
                        snackStateFlow = cashTransferScreenViewModel.snackBarStateFlow,
                        showProgressBar = !isBootstrapComplete || vmShowProgressBar,
                        viewModel = cashTransferScreenViewModel
                    )
                }
            }
        }
