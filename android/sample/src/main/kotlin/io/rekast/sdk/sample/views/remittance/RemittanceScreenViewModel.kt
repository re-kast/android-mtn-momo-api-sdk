...
/**
 * ViewModel for the Remittance Transfer screen, managing form field state and the resulting
 * [MomoTransaction] after a transfer request.
 */
@HiltViewModel
class RemittanceScreenViewModel @Inject constructor(private val defaultRepository: DefaultRepository, @param:ApplicationContext private val context: Context, private val sampleConfig: SampleConfig) : ViewModel() {
