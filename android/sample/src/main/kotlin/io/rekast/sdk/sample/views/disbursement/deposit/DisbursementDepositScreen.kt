...
import io.rekast.sdk.sample.ui.components.screens.DepositStatusDisplayComponent
 ...
 * result is available, or a deposit status summary once a [DepositStatus] has been returned.
 *
 ...
 * @param depositStatus LiveData holding the completed [DepositStatus]; null triggers the capture form.
 */
@Composable
fun DisbursementScreen(
    ...
    depositStatus: MutableLiveData<DepositStatus?>
) {
    MomoScaffold(
...
fun DisbursementScreenPreview() {
    DisbursementScreen(
        ...
        depositStatus = MutableLiveData(null)
    )
}
