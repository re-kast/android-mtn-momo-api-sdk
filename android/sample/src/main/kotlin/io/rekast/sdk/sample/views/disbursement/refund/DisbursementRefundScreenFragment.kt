...
class DisbursementRefundScreenFragment : Fragment() {
    ...
    /**
     * Inflates the Disbursement Refund screen Compose hierarchy, wiring up [DisbursementScreen]
        ...
        return ComposeView(requireContext()).apply {
            ...
            setContent {
                AppTheme {
                    ...
                    val vmShowProgressBar by disbursementRefundScreenViewModel.showProgressBar.observeAsState(false)
                    DisbursementScreen(
