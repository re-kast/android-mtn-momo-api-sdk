 ...
 *
 * @property partyIdType The type of identifier used ([PartyTypes]: MSISDN, EMAIL, PARTY_CODE).
 * @property partyId The actual identifier value for the party (e.g., a phone number or email address).
 */
@Serializable
data class Party(@SerialName("partyIdType") var partyIdType: PartyTypes, @SerialName("partyId") var partyId: String)
