...
data class PaymentResult(
    @SerialName("MerchantRequestID") var merchantRequestID: String,
    @SerialName("CheckoutRequestID") var checkoutRequestID: String,
    @SerialName("ResponseCode") var responseCode: String,
    @SerialName("ResponseDescription") var responseDescription: String,
    @SerialName("CustomerMessage") var customerMessage: String
)
