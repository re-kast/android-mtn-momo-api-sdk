...
/**
 * Represents the status of a transfer, returned by `getTransferStatus`
 ...
 * deserialization.
 *
 * @property amount The amount transferred to the payee account.
 ...
 * @property payee The [Party] credited by the transfer.
 ...
 * @property status The transfer lifecycle status.
 * @property reason The failure reason (`code` and `message`) when the transfer did not succeed.
 */
@Serializable
