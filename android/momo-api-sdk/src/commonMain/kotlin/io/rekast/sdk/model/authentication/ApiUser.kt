 ...
 */
@Serializable
data class ApiUser(@SerialName("providerCallbackHost") val providerCallbackHost: String? = null, @SerialName("targetEnvironment") val targetEnvironment: String? = null)
