...
/**
 * Represents the status of a Disbursements deposit, returned by `getDepositStatus`
 * (`GET /disbursement/{apiVersion}/deposit/{referenceId}`).
 *
 ...
 * deserialization.
 *
 * @property amount The amount credited to the payee account.
 ...
 * @property payee The [Party] credited by the deposit.
 ...
 * @property status The deposit lifecycle status.
 * @property reason The failure reason (`code` and `message`) when the deposit did not succeed.
 */
@Serializable
