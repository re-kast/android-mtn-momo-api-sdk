...
/**
 * Represents the status of a Collection request-to-withdraw, returned by
 * `requestToWithdrawTransactionStatus` (`GET /collection/{apiVersion}/requesttowithdraw/{referenceId}`).
 *
 ...
 * @property externalId The external id provided when the request-to-withdraw transaction was created.
 * @property payer The [Party] prompted to approve the withdrawal.
 ...
 * @property status The request-to-withdraw lifecycle status.
 * @property reason The failure reason (`code` and `message`) when the request-to-withdraw did not succeed.
 */
@Serializable
data class RequestToWithdrawStatus(
