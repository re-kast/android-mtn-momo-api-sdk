 ...
 */
@Serializable
data class BcAuthorizeResponse(@SerialName("auth_req_id") var authReqId: String, @SerialName("interval") var interval: Int, @SerialName("expires_in") var expiresIn: Int)
